...
from weblens.analyzers.seo import SeoMetadataAnalyzer
...
REGISTRY: tuple[AnalyzerEntry, ...] = (
    # --- technology ---------------------------------------------------------------------
    AnalyzerEntry(
        "technology.stack", SectionKey.TECHNOLOGY, "0.0.0",
    ...
    AnalyzerEntry(
        "technology.framework", SectionKey.TECHNOLOGY, "0.0.0",
    ...
    AnalyzerEntry(
        "seo.indexability", SectionKey.SEO, "0.0.0",
